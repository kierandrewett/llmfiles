...
2. **Spawn executor agents:**
   ...
   Task(
     ...
     prompt="
       ...
       @/home/kieran/.config/opencode/get-shit-done/references/tdd.md
       </execution_context>
...
Read and follow `/home/kieran/.config/opencode/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
