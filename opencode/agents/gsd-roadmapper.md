...
Reference full template: `/home/kieran/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/kieran/.config/opencode/get-shit-done/templates/state.md`.
