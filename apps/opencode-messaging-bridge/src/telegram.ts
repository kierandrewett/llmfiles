...
export const TELEGRAM_BRIDGE_BOT_COMMANDS: TelegramBotCommand[] = [
    ...
    { command: "jobs", description: "List scheduled OpenCode prompts" },
    { command: "schedule", description: "Schedule a prompt for the active session" },
    { command: "unschedule", description: "Remove a scheduled prompt" },
    { command: "run_now", description: "Run a scheduled prompt now" },
